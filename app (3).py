...
.nota-box {
    ...
    border: 1px solid rgba(0, 70, 110, 0.18);
    border-radius: 16px;
    padding: 22px 26px;
...
mostra_nota_metodologica = st.checkbox("📋 Apri nota metodologica", value=False)

if mostra_nota_metodologica:

    st.markdown("""
<div class="nota-box">

<p>
La dashboard analizza l’evoluzione degli eventi sportivi in Italia nel periodo <strong>2004-2021</strong>,
...
<p>
Il dataset di riferimento raccoglie informazioni annuali sugli spettacoli sportivi, organizzate per territorio
e, dove disponibile, per categoria sportiva. L’analisi consente di osservare sia l’andamento nazionale nel lungo periodo
sia le differenze tra regioni e macroaree territoriali.
</p>

<h4>Perimetro dell’analisi</h4>

<p>
L’analisi prende in considerazione gli eventi sportivi registrati in Italia tra il <strong>2004 e il 2021</strong>.
</p>

<p>I dati sono letti su tre livelli territoriali:</p>

<ul>
<li><strong>nazionale</strong>, per osservare l’andamento complessivo del settore;</li>
<li><strong>macroterritoriale</strong>, attraverso il confronto tra Nord-Ovest, Nord-Est, Centro, Sud e Isole;</li>
<li><strong>regionale</strong>, per evidenziare differenze e specificità dei singoli territori.</li>
</ul>

<p>
Il periodo analizzato include anche la forte discontinuità legata alla pandemia, particolarmente evidente tra il
<strong>2020 e il 2021</strong>. Questo aspetto richiede una lettura separata rispetto alle dinamiche osservate negli anni precedenti.
</p>

<h4>Indicatori considerati</h4>
...
<ul>
<li><strong>numero di spettacoli sportivi</strong>, come misura dell’offerta di eventi;</li>
<li><strong>persone partecipanti</strong>, come indicatore della dimensione del pubblico;</li>
<li><strong>persone medie per spettacolo</strong>, per valutare l’intensità media della partecipazione;</li>
<li><strong>quota regionale sul totale nazionale</strong>, per confrontare il peso relativo dei territori;</li>
<li><strong>botteghino</strong>, dove disponibile, come misura della dimensione economica degli eventi;</li>
<li><strong>botteghino medio per spettacolo</strong>, come indicatore della capacità media di generare ricavi;</li>
<li><strong>indicatori di resilienza</strong>, utili a leggere il recupero dei territori dopo la contrazione del 2020.</li>
</ul>

<p>
Per il <strong>2021</strong> è disponibile un livello di dettaglio maggiore sulle categorie sportive, che consente di distinguere tra
attività sportiva complessiva, calcio, altri sport di squadra, sport individuali e altre discipline.
</p>

<h4>Logica di lettura della dashboard</h4>
...
<p>
La <strong>panoramica nazionale</strong> sintetizza i principali indicatori disponibili.
I <strong>trend temporali</strong> mostrano l’evoluzione degli eventi sportivi nel periodo 2004-2021.
I <strong>ranking regionali</strong> permettono di confrontare i territori in base all’indicatore selezionato.
La <strong>mappa Italia</strong> offre una lettura immediata della distribuzione regionale dei valori.
Il <strong>focus categorie</strong> approfondisce la composizione degli eventi sportivi per tipologia.
La <strong>scheda regionale</strong> consente di analizzare il profilo di una singola regione.
Le <strong>tabelle dati</strong> permettono infine di consultare direttamente le principali informazioni elaborate.
</p>

<h4>Criteri di interpretazione</h4>

<p>
L’analisi ha finalità <strong>descrittiva e comparativa</strong>. I risultati consentono di individuare tendenze, differenze territoriali
e dinamiche di partecipazione, ma non devono essere interpretati come evidenza di relazioni causali dirette.
</p>

<p>
Alcuni indicatori, in particolare quelli economici e quelli legati al dettaglio per categoria sportiva, non sono disponibili
con la stessa granularità per tutti gli anni. Per questo motivo, alcune visualizzazioni mostrano esclusivamente le informazioni
effettivamente presenti nel dataset.
</p>

<p>
I valori aggregati a livello nazionale o macroterritoriale possono inoltre nascondere differenze significative tra singole regioni.
Per una lettura completa è quindi opportuno combinare la visione generale con il dettaglio territoriale.
</p>

<p>
La discontinuità del periodo pandemico rappresenta un elemento centrale dell’analisi: il confronto tra il 2020, il 2021
e gli anni precedenti deve essere letto tenendo conto del carattere eccezionale di quella fase.
</p>
